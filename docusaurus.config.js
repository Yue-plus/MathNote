      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            ...
            position: 'left',
            items: [
              {type: 'doc', label: '1. 集合', docId: '高中/集合/集合及其运算'},
              {type: 'doc', label: '2. 不等式', docId: '高中/不等式/不等式的基本性质'},
              {type: 'doc', label: '3. 函数', docId: '高中/函数/函数'},
              {type: 'doc', label: '4. 指数函数与对数函数', docId: '高中/指数函数与对数函数/指数与指数函数'},
              {type: 'doc', label: '5. 三角函数', docId: '高中/三角函数/角的概念的推广及其度量'},
              {type: 'doc', label: '6. 数列', docId: '高中/数列/数列的概念'},
              {type: 'doc', label: '7. 平面向量', docId: '高中/平面向量/向量的加减运算'},
              {type: 'doc', label: '8. 直线和圆的方程', docId: '高中/直线和圆的方程/坐标系中的基本公式'},
              {type: 'doc', label: '9. 立体几何', docId: '高中/立体几何/空间中平面的基本性质'},
